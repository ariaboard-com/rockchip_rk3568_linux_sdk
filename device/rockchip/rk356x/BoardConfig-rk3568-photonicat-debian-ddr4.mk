...
# Kernel dts
export RK_KERNEL_DTS=rk3568-photonicat
...
export RK_PARAMETER=parameter-debian-fit.txt
# Buildroot config
...
# rootfs image path
export RK_ROOTFS_IMG=rockdev/rootfs.img
...
export RK_PACKAGE_FILE=rk356x-debian-package-file
